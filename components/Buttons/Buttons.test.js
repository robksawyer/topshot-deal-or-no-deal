...
describe('components', () => {
  describe('Buttons', () => {
    it('should mount with props', function () {
      const wrap = mount(<Buttons>Hello World</Buttons>)
    ...
    it('should render as type and with content', function () {
      const wrap = render(<Buttons>Hello World</Buttons>)

      expect(wrap[0].type).toEqual('tag')
      expect(wrap[0].name).toEqual('div')
      // contain styles
      expect(wrap[0].attribs.class).toContain('buttons')
